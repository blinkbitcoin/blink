...
login_admin() {
  local scopes='VIEW_ACCOUNTS VIEW_TRANSACTIONS DELETE_ACCOUNTS SEND_NOTIFICATIONS SYSTEM_CONFIG APPROVE_MERCHANT CHANGECONTACTS_ACCOUNT CHANGELEVEL_ACCOUNT LOCK_ACCOUNT VIEW_MERCHANTS MIGRATION_RETRY_GRANT'
