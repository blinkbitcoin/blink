...
export const INACTIVITY_FEE_NOTIFICATION_TIMEOUT_MS = MS_PER_SEC * 10
...
export const ADMIN_API_JWT_AUDIENCE = env.ADMIN_API_JWT_AUDIENCE
export const ADMIN_API_FROZEN_MUTATIONS = env.ADMIN_API_FROZEN_MUTATIONS
...
export const LNURL_SERVER_INTERNAL_URL = env.LNURL_SERVER_INTERNAL_URL
export const LNURL_SERVER_LN_ADDRESS_DOMAIN = env.LNURL_SERVER_LN_ADDRESS_DOMAIN
...
export const BTCMAP_API_URL = env.BTCMAP_API_URL
export const BTCMAP_API_TOKEN = env.BTCMAP_API_TOKEN
export const BTCMAP_HMAC_SECRET = env.BTCMAP_HMAC_SECRET
