        ...
        params: {
          ...
          properties: {
            decayStartAmount: {
              type: "integer",
              minimum: 0,
              exclusiveMinimum: { $data: "1/baseAmount" },
            },
            baseAmount: { type: "integer", minimum: 0 },
            decaySpeed: { type: "number", minimum: 0 },
            minFeeRate: { type: "number", minimum: 0 },
            maxFeeRate: {
              type: "number",
              minimum: 0,
...
export const configSchema = {
  ...
  properties: {
    ...
    investmentAgreement: {
      type: "object",
      properties: {
        pricePerUnitUsdCents: { type: "integer", minimum: 1 },
        preMoneyValuationUsdCents: { type: "integer", minimum: 1 },
        minUnits: { type: "integer", minimum: 1 },
        maxUnits: { type: "integer", minimum: { $data: "1/minUnits" } },
        signingReuseWindowMinutes: { type: "integer", minimum: 1, default: 15 },
        paymentWindowHours: {
          type: "integer",
          minimum: 1,
          default: 24,
          description:
            "Hours the investor has to pay after the agreement is completed. Clause 2 of the Subscription Agreement fixes it at 24: change the contract before changing this value.",
        },
        rateTimeZone: { type: "string", minLength: 1 },
        placeholderValues: {
          type: "object",
          properties: {
            fullLegalName: { type: "string", minLength: 1 },
            countryOfResidence: { type: "string", minLength: 1 },
            subMembershipTier: { type: "string", minLength: 1 },
            subMembershipTerm: { type: "string", minLength: 1 },
          },
          required: [
            "fullLegalName",
            "countryOfResidence",
