        ...
        params: {
          ...
          properties: {
            threshold: {
              type: "integer",
              minimum: 0,
              exclusiveMinimum: { $data: "1/minAmount" },
            },
            minAmount: { type: "integer", minimum: 0 },
            exponentialFactor: { type: "number", minimum: 0 },
            minNetworkFeeRate: { type: "number", minimum: 0 },
            maxNetworkFeeRate: {
              type: "number",
              minimum: 0,
              exclusiveMinimum: { $data: "1/minNetworkFeeRate" },
            },
      ...
      default: [
        ...
        },
        {
          ...
          params: {
            threshold: 4000000,
            minAmount: 21000,
            exponentialFactor: 21.0,
            minNetworkFeeRate: 1,
            maxNetworkFeeRate: 2000,
            minRate: 0.0075,
            maxRate: 0.04,
            divisor: 30000,
            targetRate: 0.005,
